...
fun VideoStepRecordingInfo(
    ...
    infoBodyColor: Color,
    reviewButton: String,
    reviewButtonColor: Color,
    reviewButtonTextColor: Color,
    onCloseClicked: () -> Unit = {},
    ...
    Column(
        ...
        ForYouAndMeButton(
            ...
            textColor = reviewButtonTextColor,
...
private fun VideoStepRecordingInfoPreview() {
    ForYouAndMeTheme {
        VideoStepRecordingInfo(
            ...
            reviewButtonColor = Color.Red,
            reviewButtonTextColor = Color.White
        )
    }
}