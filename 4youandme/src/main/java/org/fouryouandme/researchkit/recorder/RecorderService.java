...
public class RecorderService extends Service implements RecorderListener, TextToSpeech.OnInitListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null && intent.getExtras() != null) {
            ...
            if (bundle.containsKey(EXTRA_STEP)) {
                step = (ActiveStep) bundle.getSerializable(EXTRA_STEP);
            }
        ...
        if (step != null && step.getStepDuration() > 0 &&
            ...
            if (step.getSoundRes() != null) {
                @RawRes int soundRes = ResUtils
                        .getRawResourceId(this, step.getSoundRes());
                if (soundRes == 0) {
                    LogExt.e(RecorderService.class,
                            "Error finding ActiveStep's sound " + step.getSoundRes());
                } else {
            ...
            setStartTime(getApplicationContext(), step, startTime);
            ...
            if (step.getRecorderConfigurationList() != null) {
                for (RecorderConfig recorderConfig : step.getRecorderConfigurationList()) {
                    Recorder recorder = recorderConfig.recorderForStep(step, outputDir);
    ...
    protected void startSpeechToTextMap() {
        ...
        Map<String, String> speechToTextMap = step.getSpokenInstructionMap();
            ...
            for (String speechKey : speechToTextMap.keySet()) {
                ...
                if (TEXT_TO_SPEECH_END_KEY.equals(speechKey)) {
                    ...
                    try {
                        ...
                        long stopTimeInMs = step.getStepDuration() * 1000L;
    ...
    public void onDestroy() {
        ...
        if (isServiceRunning && shouldCancelRecordersOnDestroy) {
            ...
            removeStartTime(getApplicationContext(), step);
    ...
    private void showForegroundNotification(String notificationMessage) {
        ...
        Intent notificationIntent = new Intent(this, step.getActivityClazz());
        ...
        notificationIntent.putExtra(ViewTaskActivity.EXTRA_STEP, step);
    ...
    private void sendRecorderErrorBroadcast(String errorMessage) {
        ...
        setSavedResultList(getApplicationContext(), step, resultHolder);
    ...
    private void onRecorderDurationFinished() {
        ...
        }, step.getEstimateTimeInMsToSpeakEndInstruction());
    }
